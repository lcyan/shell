...
安装或更新 [CC Switch](https://github.com/farion1231/cc-switch)。脚本会自动识别 Debian/Ubuntu 系统架构，并从官方 latest release 下载对应 `.deb` 包安装。

当前支持：

- `amd64`：下载 `CC-Switch-<version>-Linux-x86_64.deb`
- `arm64`：下载 `CC-Switch-<version>-Linux-arm64.deb`
