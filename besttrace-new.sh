...
# Usage (local): sudo bash besttrace-new.sh
# Usage (remote): curl -fsSL https://raw.githubusercontent.com/lcyan/shell/master/besttrace-new.sh | sudo bash
# =========================================================
...
print_final_summary() {
    ...
    echo -e "${GREEN}#      仓库命令：sudo bash besttrace-new.sh                #${PLAIN}"
